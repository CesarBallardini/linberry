...
#ifndef __LINBERRY_COMMON_H__
#define __LINBERRY_COMMON_H__
...
// minimum number of password tries remaining at which Linberry gives up
// for safety
#define LINBERRY_MIN_PASSWORD_TRIES	3
#define LINBERRY_MIN_PASSWORD_TRIES_ASC	"3"
