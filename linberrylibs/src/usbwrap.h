...
class BXEXPORT Error : public Linberry::Error
{
...
public:
	...
	bool BulkRead(int ep, Linberry::Data &data, int timeout = -1);
	bool BulkWrite(int ep, const Linberry::Data &data, int timeout = -1);
	bool BulkWrite(int ep, const void *data, size_t size, int timeout = -1);
	bool InterruptRead(int ep, Linberry::Data &data, int timeout = -1);
	bool InterruptWrite(int ep, const Linberry::Data &data, int timeout = -1);
