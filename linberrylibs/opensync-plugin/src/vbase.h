...
#ifndef __LINBERRY_SYNC_VBASE_H__
#define __LINBERRY_SYNC_VBASE_H__

#include <string>
#include <stdexcept>
#include <linberry/vsmartptr.h>
#include "vformat.h"
...
typedef Linberry::vSmartPtr<b_VFormatAttribute, b_VFormatAttribute, &b_vformat_attribute_free> vAttrPtr;
typedef Linberry::vSmartPtr<b_VFormatParam, b_VFormatParam, &b_vformat_attribute_param_free> vParamPtr;
typedef Linberry::vSmartPtr<char, void, &g_free> gStringPtr;
...
public:
	// FIXME - if you put this class in the Linberry library,
