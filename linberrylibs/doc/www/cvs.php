...
<? createHeader("Installing Linberry"); ?>
...
<ul>
	...
	<li>download the development tree
		<a href="http://repo.or.cz/w/linberry.git">using git</a></li>
</ul>
</p>
...
command, for example:
<pre>
	dpkg-source -x linberry_0.15-0.dsc
</pre>
</p>
...
<pre>
	cvs -d:pserver:anonymous@linberry.cvs.sourceforge.net:/cvsroot/linberry login
	(press enter when it asks for password)
	cvs -d:pserver:anonymous@linberry.cvs.sourceforge.net:/cvsroot/linberry co -P linberry
</pre>
</p>

<p>This will place the Linberry sources in the linberry directory.  To update
...
on the web at the <a href="http://repo.or.cz/w/linberry.git">Linberry git page</a>.
You can clone the repository like this:

<pre>
	git clone git://repo.or.cz/linberry.git linberry
</pre>
</p>
...
<p>At this point, or if you are using a source tarball, building Linberry
...
bidentify, bjavaloader, pppob), as well as the backup GUI (linberrybackup),
...
<p>If you install Linberry in a location other than /usr, you will need
...
<? createSubHeader("Building Linberry RPMs from CVS"); ?>
...
<pre>
	...
	$ make dist
	$ rpmbuild -tb linberry-0.13.tar.gz
...
<? createSubHeader("Building Linberry DEBs from Source"); ?>
