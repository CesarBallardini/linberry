...
<? createHeader("linberry - Design"); ?>

<? createSubHeader("Architecture"); ?>

<p>Linberry is designed to be modular in many ways.
...
<p>Flexible Synchronization Targets: The main goal of linberry is to
...
their data.  To address this linberry needs to be flexible in how it supports
synchronization.  It should be easy to add new synchronization targets
to linberry and easy to select these targets from the user interface.  </p>
...
on a single user profile.  Linberry will be able to treat each device
