...
<? createHeader("linberry - BlackBerry &trade; synchronization for Linux"); ?>
...
<p>Linberry is an Open Source application that will provide synchronization,
backup, restore and program management for BlackBerry &trade; devices.
Linberry is primarily developed on Linux, but is intended as a cross platform
library and application set, targeting Linux, BSD, 32/64bit, and big/little
endian systems.
</p>

<p>The Linberry project began in October 2005 and has steadily added features
...
<ul>
	...
	<li>General <a href="http://sourceforge.net/projects/linberry/">Sourceforge project page</a></li>
	<li><a href="http://repo.or.cz/w/linberry.git">Linberry git repo</a></li>
	<li>Additional binary packages for the following distributions are available from various volunteers:
		<ul>
			<li><a href="http://packages.debian.org/unstable/main/linberry-util">Debian, in the unstable tree, packaged by Jose Carlos Garcia Sogo</a></li>
			<li><a href="http://koji.fedoraproject.org/koji/packageinfo?packageID=7118">Fedora, packaged by Christopher D. Stover</a>, and the related RPM <a href="http://cvs.fedoraproject.org/viewvc/rpms/linberry/">CVS</a></li>
			<li>Mandriva, packaged by Adam Williamson, and the related RPM <a href="http://svn.mandriva.com/cgi-bin/viewvc.cgi/packages/cooker/linberry/current/">SVN</a></li>
			<li><a href="https://launchpad.net/~doctormo/+archive/linberry-snapshot">Ubuntu, packaged by Martin Owens</a></li>
		</ul>
	</li>
	<li>Known Issues:
	<ul>
		<li>International characters in calendar and contact records
			...
			protocol, which Linberry does not yet support.</li>
...
<p>How do I...
<ul>
	<li><? createLink("install", "Install Linberry from binary packages"); ?></li>
	<li><? createLink("cvs", "Compile Linberry from tarball, CVS, or git"); ?></li>
...
<ul>
	...
	<li><? createFileLink("doxygen/html/index.html", "Linberry's Doxygen documentation"); ?></li>
...
would like to create and test a Python interface to the Linberry library.</p>

<p>If you are not a programmer, but have a Blackberry, we can always use
help in testing.  Install Linberry on your system, and
...
<? createLink("hacking", "Linberry hacking document"); ?> that will help you.
</p>
...
want to take Linberry. Check out our <? createLink("roadmap", "roadmap"); ?>
to see what's happening.</p>


<? createSubHeader("External Links"); ?>

<p>Linberry users and others have contributed documentation and have
