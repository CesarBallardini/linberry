...
if [ -z "$1" ] ; then
	echo "Using Linberry default web doc config..."
	...
	mkdir -p www.netdirect.ca/sites/www.netdirect.ca/files/linberry/doxygen
	mkdir -p www.netdirect.ca/sites/www.netdirect.ca/files/images/linberry
	cp *.png www.netdirect.ca/sites/www.netdirect.ca/files/images/linberry
