...
<? createHeader("linberry - Software dependencies"); ?>
...
<p>The following list contains all software that Linberry depends on, and
...
<ul>
	...
	<li><b>gtkmm, glademm, glibmm</b> C++ versions of the GTK libraries (needed for the linberrybackup GUI)</li>
	<li><b>libtar</b> (linberrybackup GUI) </li>
	<li><b>zlib</b>, needed for CRC32 checksums in library COD file support,
		and used by the linberrybackup GUI</li>
...
<p>The following is a list of packages you'll need to install to build Linberry
