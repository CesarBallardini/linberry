///
/// \file	addcalendar.cc
///		Example code using the Linberry library to add a calendar
...
void ReadInput(Linberry::Calendar &cal)
{
...
void Upload(const Linberry::ProbeResult &device, const Linberry::Calendar &cal)
{
