				      ...
				      const IConverter *ic)
{
	...
	case CLLFC_STATUS:
		...
		case 0x00:
			StatusFlag = Linberry::CallLog::OK;
			break;
		case 0x01:
			StatusFlag = Linberry::CallLog::Busy;
			break;
		case 0x09:
			StatusFlag = Linberry::CallLog::NetError;
			break;
		default:
			StatusFlag = Linberry::CallLog::Unknown;
		}
		return begin;
	...
	case CLLFC_PHONE_TYPE:
		if( field->u.raw[0] > CLL_PHONETYPE_RANGE_HIGH ) {
			PhoneTypeFlag = Linberry::CallLog::TypeUnknown;
		}
		else {
	...
	case CLLFC_PHONE_INFO:
		switch (field->u.raw[0]) {
		case 0x03:
			PhoneInfoFlag = Linberry::CallLog::InfoKnown;
			break;
		case 0x80:
			PhoneInfoFlag = Linberry::CallLog::InfoUnknown;
			break;
		case 0x40:
			PhoneInfoFlag = Linberry::CallLog::InfoPrivate;
			break;
		default:
			PhoneInfoFlag = Linberry::CallLog::InfoUndefined;
		}
		return begin;
...
void CallLog::Dump(std::ostream &os) const
{
	...
	static const char *StatusName[] = { "OK", "Busy", "Error", "Not supported by Linberry" };
	static const char *PhoneInfoName[] = { "Undefined", "Known phone number", "Unknown phone number", "Private phone number" };
	static const char *PhoneTypeName[] = { "Unknown", "Office", "Home", "Mobile", "Not supported by Linberry" };
...
void CallLog::Clear()
{
	...
	DirectionFlag = Linberry::CallLog::Receiver;
	StatusFlag = Linberry::CallLog::Unknown;
	PhoneTypeFlag = Linberry::CallLog::TypeUnknown;
	PhoneInfoFlag = Linberry::CallLog::InfoUndefined;
