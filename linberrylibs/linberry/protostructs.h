...
///
///		Do not include this in any Linberry library header.
...
#ifndef __LINBERRY_PROTOSTRUCTS_H__
#define __LINBERRY_PROTOSTRUCTS_H__

#include <stdint.h>
#include <sys/types.h>

// forward declarations
namespace Linberry { class Data; }

namespace Linberry { namespace Protocol {
...
#define SMS_METADATA_SIZE	(sizeof(Linberry::Protocol::SMSMetaData))
...
#define COMMON_FIELD_HEADER_SIZE	(sizeof(Linberry::Protocol::CommonField) - sizeof(Linberry::Protocol::CommonField::CommonFieldData))
...
#define COMMAND_FIELD_HEADER_SIZE	(sizeof(Linberry::Protocol::CommandTableField) - 1)
...
#define OLD_DBDB_FIELD_HEADER_SIZE	(sizeof(Linberry::Protocol::OldDBDBField) - 1)
...
#define DBDB_FIELD_HEADER_SIZE	(sizeof(Linberry::Protocol::DBDBField) - 1)
...
struct RecordStateTableField
{
	...
	uint8_t		flags;			// bit 0x01 is the dirty flag
						...
						// are used
#define LINBERRY_RSTF_DIRTY	0x01
	uint8_t		unknown2[4];
} __attribute__ ((packed));
...
#define CALENDAR_RECURRENCE_DATA_FIELD_SIZE	sizeof(Linberry::Protocol::CalendarRecurrenceDataField)
...
#define PACKED_FIELD_02_HEADER_SIZE	(sizeof(Linberry::Protocol::PackedField_02) - 1)
...
#define PACKED_FIELD_10_HEADER_SIZE	(sizeof(Linberry::Protocol::PackedField_10) - 1)
...
#define SERVICE_BOOK_CONFIG_FIELD_HEADER_SIZE (sizeof(Linberry::Protocol::ServiceBookConfigField) - 1)
...
#define DBC_RECORD_HEADER_SIZE		(sizeof(Linberry::Protocol::DBC_Record) - 1)
...
#define DBC_RECORD_FLAGS_SIZE		(sizeof(Linberry::Protocol::DBC_RecordFlags))
...
#define DBC_TAGGED_UPLOAD_HEADER_SIZE	(sizeof(Linberry::Protocol::DBC_TaggedUpload) - 1)
...
#define DBC_INDEXED_UPLOAD_HEADER_SIZE	(sizeof(Linberry::Protocol::DBC_IndexedUpload) - 1)
...
#define PASSWORD_CHALLENGE_HEADER_SIZE	(sizeof(Linberry::Protocol::PasswordChallenge) - sizeof(Linberry::Protocol::PasswordChallenge::Hash))
#define PASSWORD_CHALLENGE_SEED_SIZE	(PASSWORD_CHALLENGE_HEADER_SIZE + sizeof(uint32_t))
#define PASSWORD_CHALLENGE_SIZE		(sizeof(Linberry::Protocol::PasswordChallenge))
...
#define ATTRIBUTE_FETCH_COMMAND_SIZE	(sizeof(Linberry::Protocol::AttributeFetch) - 1)
...
#define ECHO_COMMAND_SIZE		(sizeof(Linberry::Protocol::Echo))
...
#define SOCKET_COMMAND_HEADER_SIZE		(sizeof(Linberry::Protocol::SocketCommand) - sizeof(Linberry::Protocol::SocketCommand::PacketData))
...
#define DB_COMMAND_HEADER_SIZE		(sizeof(Linberry::Protocol::DBCommand) - sizeof(Linberry::Protocol::DBCommand::Parameters))
...
#define OLD_DBDB_RECORD_HEADER_SIZE	(sizeof(Linberry::Protocol::DBR_OldDBDBRecord) - sizeof(Linberry::Protocol::OldDBDBField))
...
#define DBDB_RECORD_HEADER_SIZE		(sizeof(Linberry::Protocol::DBR_DBDBRecord) - sizeof(Linberry::Protocol::DBDBField))
...
#define DBR_OLD_TAGGED_RECORD_HEADER_SIZE (sizeof(Linberry::Protocol::DBR_OldTaggedRecord) - sizeof(Linberry::Protocol::DBR_OldTaggedRecord::TaggedData))
...
#define MESSAGE_RECORD_HEADER_SIZE (sizeof(Linberry::Protocol::MessageRecord) - sizeof(Linberry::Protocol::CommonField))
...
#define DB_RESPONSE_HEADER_SIZE		(sizeof(Linberry::Protocol::DBResponse) - sizeof(Linberry::Protocol::DBResponse::Parameters))
...
#define SB_DBACCESS_HEADER_SIZE			(sizeof(Linberry::Protocol::DBAccess) - sizeof(Linberry::Protocol::DBAccess::DBData))
...
#define SB_JLDIRENTRY_HEADER_SIZE		(sizeof(Linberry::Protocol::JLDirEntry) - 1)
...
#define SB_JLCOMMAND_HEADER_SIZE		(sizeof(Linberry::Protocol::JLCommand))
...
#define SB_JLRESPONSE_HEADER_SIZE		(sizeof(Linberry::Protocol::JLResponse))
...
#define SB_JLSCREENINFO_SIZE			(sizeof(Linberry::Protocol::JLScreenInfo))
...
#define SB_JLEVENTLOG_ENTRY_HEADER_SIZE		(sizeof(Linberry::Protocol::JLEventlogEntry))
...
#define SB_JLDEVICEINFO_SIZE			(sizeof(Linberry::Protocol::JLDeviceInfo))
...
#define SB_JLPACKET_HEADER_SIZE		(sizeof(Linberry::Protocol::JLPacket) - sizeof(Linberry::Protocol::JLPacket::PacketData))
...
namespace JDWP {
	...
	#define JDWP_COMMAND_HEADER_SIZE			(sizeof(Linberry::Protocol::JDWP::PacketCommand))
	...
	#define JDWP_PACKETVIRTUALMACHINEIDSIZES_DATA_SIZE		sizeof(Linberry::Protocol::JDWP::PacketVirtualMachineIDSizes)
	...
	#define JDWP_RESPONSE_HEADER_SIZE			(sizeof(Linberry::Protocol::JDWP::PacketResponse) - sizeof(Linberry::Protocol::JDWP::PacketResponse::PacketResponseData))
	...
	#define JDWP_PACKET_HEADER_SIZE			(sizeof(Linberry::Protocol::JDWP::Packet) - sizeof(Linberry::Protocol::JDWP::Packet::PacketType))


	#define MAKE_JDWPPACKET(var, data)		const Linberry::Protocol::JDWP::Packet *var = (const Linberry::Protocol::JDWP::Packet *) (data).GetData()
	#define MAKE_JDWPPACKETPTR_BUF(var, ptr)		Linberry::Protocol::JDWP::Packet *var = (Linberry::Protocol::JDWP::Packet *)ptr
...
#define JDWP_FIELD_HEADER_SIZE			(sizeof(Linberry::Protocol::JDWField) - sizeof(Linberry::Protocol::JDWField::JDWFieldData))
...
#define SB_JVMCOMMAND_HEADER_SIZE		(sizeof(Linberry::Protocol::JVMCommand))
...
#define SB_JVMRESPONSE_HEADER_SIZE		(sizeof(Linberry::Protocol::JVMResponse))
...
#define SB_JVMMODULES_LIST_HEADER_SIZE		(sizeof(Linberry::Protocol::JVMModulesList))
...
#define SB_JVMMODULES_ENTRY_HEADER_SIZE		(sizeof(Linberry::Protocol::JVMModulesEntry))
...
#define SB_JVMTHREADS_LIST_HEADER_SIZE		(sizeof(Linberry::Protocol::JVMThreadsList))
...
#define SB_JVMUNKNOWN01_HEADER_SIZE			(sizeof(Linberry::Protocol::JVMUnknown01))
...
#define SB_JVMUNKNOWN02_HEADER_SIZE			(sizeof(Linberry::Protocol::JVMUnknown02))
...
#define SB_JVMPACKET_HEADER_SIZE		(sizeof(Linberry::Protocol::JVMPacket) - sizeof(Linberry::Protocol::JVMPacket::PacketData))
...
#define SB_PACKET_HEADER_SIZE			(sizeof(Linberry::Protocol::Packet) - sizeof(Linberry::Protocol::Packet::PacketData))
...
#define SB_SEQUENCE_PACKET_SIZE			(SB_PACKET_HEADER_SIZE + sizeof(Linberry::Protocol::SequenceCommand))
#define SB_SOCKET_PACKET_HEADER_SIZE		(SB_PACKET_HEADER_SIZE + SOCKET_COMMAND_HEADER_SIZE)
#define SB_MODE_PACKET_COMMAND_SIZE		(SB_SOCKET_PACKET_HEADER_SIZE + sizeof(Linberry::Protocol::ModeSelect) - sizeof(Linberry::Protocol::ModeSelect::ResponseBlock))
#define SB_MODE_PACKET_RESPONSE_SIZE		(SB_SOCKET_PACKET_HEADER_SIZE + sizeof(Linberry::Protocol::ModeSelect))


// Macros
#define COMMAND(data)				(((const Linberry::Protocol::Packet *)data.GetData())->command)
#define IS_COMMAND(data, cmd)			(COMMAND(data) == cmd)
#define MAKE_PACKET(var, data)			const Linberry::Protocol::Packet *var = (const Linberry::Protocol::Packet *) (data).GetData()
#define MAKE_JLPACKET(var, data)		const Linberry::Protocol::JLPacket *var = (const Linberry::Protocol::JLPacket *) (data).GetData()
#define MAKE_JVMPACKET(var, data)		const Linberry::Protocol::JVMPacket *var = (const Linberry::Protocol::JVMPacket *) (data).GetData()
#define MAKE_PACKETPTR_BUF(var, ptr)		Linberry::Protocol::Packet *var = (Linberry::Protocol::Packet *)ptr
#define MAKE_JLPACKETPTR_BUF(var, ptr)		Linberry::Protocol::JLPacket *var = (Linberry::Protocol::JLPacket *)ptr
#define MAKE_JVMPACKETPTR_BUF(var, ptr)		Linberry::Protocol::JVMPacket *var = (Linberry::Protocol::JVMPacket *)ptr
...
void CheckSize(const Linberry::Data &packet, size_t requiredsize);
unsigned int GetSize(const Linberry::Data &packet);

}} // namespace Linberry::Protocol
