...
#ifndef __LINBERRY_CONTROLLER_H__
#define __LINBERRY_CONTROLLER_H__
...
{
	friend class Linberry::Mode::Mode;
	friend class Linberry::Mode::IpModem;
	friend class Linberry::Mode::Serial;
	friend class Linberry::Mode::JavaLoader;
	friend class Linberry::Mode::JVMDebug;
