...
#ifndef __LINBERRY_LINBERRY_H__
#define __LINBERRY_LINBERRY_H__

/**

	\mainpage Linberry Reference Manual


	\section getting_started Getting Started

	Welcome to the Linberry reference manual.  This entire manual was
	...
	source code to the Linberry command line tool: btool.cc


	\section classes Major Classes

	To get started with the API, see the Linberry::Controller class.
