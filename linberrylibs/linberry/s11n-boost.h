...
#ifndef __LINBERRY_S11N_BOOST_H__
#define __LINBERRY_S11N_BOOST_H__
...
// special versions
//
// LINBERRY_BASE_S11N_VERSION      - the base version where all record data is
//                                stored so it can be fully retrieved and
//                                uploaded to the handheld device later.
// LINBERRY_POD_MAP_VERSION        - if these templates are called with a version
//                                equal or greater than this, only mappable,
//                                POD data is included in the serialization
//
#define LINBERRY_BASE_S11N_VERSION		0
#define LINBERRY_POD_MAP_VERSION		1000
...
void serialize(ArchiveT &ar, Linberry::UnknownField &uf, const unsigned int ver)
{
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::Contact::GroupLink &g, const unsigned int ver)
{
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::CategoryList &cl, const unsigned int ver)
{
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::Contact &c, const unsigned int ver)
{
	...
	if( ver < LINBERRY_POD_MAP_VERSION ) {
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::EmailAddress &a, const unsigned int ver)
{
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::Message &m, const unsigned int ver)
{
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::Calendar &c, const unsigned int ver)
{
	ar & make_nvp("RecType", c.RecType);
	ar & make_nvp("RecordId", c.RecordId);
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::CallLog &c, const unsigned int ver)
{
	ar & make_nvp("RecType", c.RecType);
	ar & make_nvp("RecordId", c.RecordId);
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::ServiceBookConfig &c, const unsigned int ver)
{
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::ServiceBook &c, const unsigned int ver)
{
	ar & make_nvp("RecType", c.RecType);
	ar & make_nvp("RecordId", c.RecordId);
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::Memo &m, const unsigned int ver)
{
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::Task &t, const unsigned int ver)
{
...
template<class ArchiveT>
void serialize(ArchiveT &ar, Linberry::PINMessage &p, const unsigned int ver)
{
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::SavedMessage &m, const unsigned int ver)
{
	ar & make_nvp("RecType", m.RecType);
	ar & make_nvp("RecordId", m.RecordId);
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::Sms &m, const unsigned int ver)
{
	ar & make_nvp("RecType", m.RecType);
	ar & make_nvp("RecordId", m.RecordId);
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::Folder &f, const unsigned int ver)
{
...
template <class ArchiveT>
void serialize(ArchiveT &ar, Linberry::Timezone &t, const unsigned int ver)
{
	ar & make_nvp("RecType", t.RecType);
	ar & make_nvp("RecordId", t.RecordId);
