...
#ifndef __LINBERRY_RECORD_INTERNAL_H__
#define __LINBERRY_RECORD_INTERNAL_H__
...
void BuildField(Data &data, size_t &size, const Linberry::UnknownField &field);
void BuildField(Data &data, size_t &size, uint8_t type, const Linberry::Protocol::GroupLink &link);
std::string ParseFieldString(const Linberry::Protocol::CommonField *field);
std::string ParseFieldString(const void *data, uint16_t maxlen);


// Functions to help build JDWP command packets
void AddJDWByte(Linberry::Data &data, size_t &size, const uint8_t value);
void AddJDWInt(Linberry::Data &data, size_t &size, const uint32_t value);
void AddJDWChar(Linberry::Data &data, size_t &size, const void *buf, size_t bufsize);
void AddJDWString(Linberry::Data &data, size_t &size, const std::string &str);
