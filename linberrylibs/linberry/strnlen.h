...
#ifndef __LINBERRY_STRNLEN_H__
#define __LINBERRY_STRNLEN_H__
...
size_t linberry_strnlen(const char *s, size_t maxlen);
...
#define strnlen(s,l) linberry_strnlen(s,l)

#endif	// !HAVE_WORKING_STRNLEN

#endif	// __LINBERRY_STRNLEN_H__
