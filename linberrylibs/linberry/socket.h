...
#ifndef __LINBERRY_SOCKET_H__
#define __LINBERRY_SOCKET_H__
...
public:
	...
	void Send(Linberry::Packet &packet, int timeout = -1);
...
public:
	...
	void Packet(Linberry::Packet &packet, int timeout = -1);
	void Packet(Linberry::JLPacket &packet, int timeout = -1);
	void Packet(Linberry::JVMPacket &packet, int timeout = -1);
