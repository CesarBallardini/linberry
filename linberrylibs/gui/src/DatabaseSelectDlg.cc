...
DatabaseSelectDlg::DatabaseSelectDlg(const Linberry::DatabaseDatabase &dbdb,
...
void DatabaseSelectDlg::LoadTree(const Linberry::DatabaseDatabase &dbdb)
{
	...
	m_pTree->append_column_editable("Marca", m_Columns.m_selected);
	m_pTree->append_column("Nombre", m_Columns.m_name);
}
