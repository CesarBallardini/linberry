...
#ifndef __LINBERRYBACKUP_DATABASESELECTDLG_H__
#define __LINBERRYBACKUP_DATABASESELECTDLG_H__
...
protected:
	void LoadTree(const Linberry::DatabaseDatabase &dbdb);
	bool IsSelected(const std::string &dbname);
	void SaveSelections();

public:
	DatabaseSelectDlg(const Linberry::DatabaseDatabase &dbdb,
