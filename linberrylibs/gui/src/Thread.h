...
#ifndef __LINBERRYBACKUP_THREAD_H__
#define __LINBERRYBACKUP_THREAD_H__
...
public:
	...
	const Linberry::DatabaseDatabase &GetDBDB() { return m_interface.GetDBDB(); }
